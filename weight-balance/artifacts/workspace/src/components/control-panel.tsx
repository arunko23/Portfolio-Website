    ...
    <aside className="flex flex-col gap-5 rounded-xl border border-border bg-surface p-5 lg:sticky lg:top-4">
      ...
      <div className="rounded-lg border border-border bg-surface-2 p-4">
        ...
        {neighbours && last ? (
          ...
          <p className="mt-3 text-xs leading-relaxed text-muted">
            Line locked to the printed {last.cgMm} mm mark from the bottom scale to the top
            scale.
          </p>
        ) : null}
      </div>
      ...
      <p className="text-xs leading-relaxed text-subtle">
        Reference: the graph is the actual Figure 1/3 from page 9 of the supplied AMM. Plotted
        lines follow the printed millimetre marks — they are not a single-slope approximation.
      </p>
    </aside>
  );
}
